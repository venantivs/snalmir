...
enum user_mode { 
	USER_EMPTY, USER_ACCEPT, USER_LOGIN, USER_NUMERIC_PASSWORD,
	USER_NUMERIC_PASSWORD_CHANGE, USER_NUMERIC_PASSWORD_RSUCCESS, 
	USER_SELCHAR = 11, USER_CHARWAIT = 12, USER_CREWAIT = 13, USER_DELWAIT = 14, 
	USER_PLAY = 22, USER_SAVING_TO_QUIT = 24 };
